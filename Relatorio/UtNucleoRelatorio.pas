...
begin
  MessageBox(0, 'Espero que você entenda o que irei fazer aqui, isso consumira processamento e pode demorar uns instantes!', 'Que trabalhão', MB_ICONINFORMATION or MB_OK);
