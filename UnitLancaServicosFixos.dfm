object FormLancaServicosFixos: TFormLancaServicosFixos
  Left = 0
  Top = 0
  AlphaBlend = True
  AlphaBlendValue = 215
  BorderIcons = [biSystemMenu]
  Caption = 'Cadastro de Servi'#231'os Fixos'
  ClientHeight = 424
  ClientWidth = 491
  Color = clBtnFace
  ...
  object DtCadastro: TDataSource
    DataSet = pai.QrSRVFIX
    Left = 460
    Top = 112
  end
  object DtSetman: TDataSource
