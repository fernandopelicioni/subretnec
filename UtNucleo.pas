...
begin
          ...
          if pai.QrColigadas.Active = true then
                 Panel3.Caption:='  Logado em : ' + Pai.QrColigadas.FieldByName('Des_Coligada').AsString + '   |   Usuário : ' + Pai.QrUsuarios.FieldByName('usu_Nome').AsString
                 else
...
//                Panel3.Caption:= 'Usuário : ' + Pai.QrUsuarios.FieldByName('Usu_Nome').AsString + ' - ' + FormIniciaSistema.editversao.Caption + ' | Coligada : ' + Pai.QrColigadas.FieldByName('Des_Coligada').AsString;
