                     ...
                     begin
                           with q do
                                 begin
                                      ...
                                      if not eof then
                                             begin
                                                  ShowMessage('Já existe um Pneu com esse número de fogo nesta empresa, Escolha um novo numero ou exclua o anterior');
                                                  Abort;
                                             end;
                                 end;
                     end;
...
If MessageDlg('Você deseja excluir este Pneu, Verifique se ele já não foi movimentado',
      mtConfirmation,[mbno, mbyes],0)
         ...
         begin
               ...
               Except
                      ShowMessage('Pneu ja foi movimentado, e não pode ser instalado');
               end;
