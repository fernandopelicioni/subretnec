...
begin
   With QrDirecao do
       begin
            ...
            Chart2.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
   ...
   With QrFreios do
       begin
            ...
            Chart3.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
    ...
    With QrOrc1 do
       begin
            ...
            Chart1.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
    ...
    With QrMotor do
       begin
            ...
            Chart4.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
 ...
 //lantenagem
    With QrLanternagem do
       begin
            ...
            Chart5.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
...
//suspensao
   With QrSuspensao do
       begin
            ...
            Chart6.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
...
// trnsamissao
   With QrTransmissao do
       begin
            ...
            Chart7.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
   ...
   With QrLimpeza do
       begin
            ...
            Chart8.Series[0].Add (FieldByName('orcado').asfloat,'Orçado' ,$00E8A601);
