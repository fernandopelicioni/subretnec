...
begin
label13.Caption:='Versão : ' + FormIniciaSistema.EditVersao.Caption;
...
Application.CreateForm(TFormOsSenha,FormOsSenha);
        ...
        begin
                MessageBox(0, 'Sua senha não é valida', 'Senha não confere', MB_ICONSTOP or MB_OK);
                Abort;
...
begin
Dataehora.Caption:='Agora são : ' + DateTimeToStr(now);
end;
