...
uses
  ...
  UnitImportaPneuCadastro in 'UnitImportaPneuCadastro.pas' {FormImportaCadPn},
  ...
  UnitImpMovPn in 'UnitImpMovPn.pas' {FormImpMovPn},
  UnitImpVeiPn in 'UnitImpVeiPn.pas' {FormImpVeiPn},
  UnitImpRef in 'UnitImpRef.pas' {FormImpRef},
