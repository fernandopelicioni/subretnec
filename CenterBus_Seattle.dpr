...
uses
  ...
  UtRltPneuDecisao in 'BY\Relatorios\UtRltPneuDecisao.pas' {FormRltPneuDecisao},
  UtEntradaSaidaSubGrupo in 'BY\Produtividade\UtEntradaSaidaSubGrupo.pas' {FormEntradaSaidaSubGrupo},
  UtCadastroProdutos in 'BY\Cadastros\UtCadastroProdutos.pas' {FormCadastroProdutos},
  UtProdutividadeCustoKm in 'BY\Produtividade\UtProdutividadeCustoKm.pas' {FormProdutividadeCustoKm},
  UtRelatorio in 'BY\Relatorios\UtRelatorio.pas' {Relatorio2: TDataModule},
  UtCroqui in 'BY\Croqui\UtCroqui.pas' {FormCroqui},
  UtSobre in 'Sobre\UtSobre.pas' {FormSobre},
  UtFormRelatorioCurvaSaidaPrd in 'Relatorio\UtFormRelatorioCurvaSaidaPrd.pas' {FormRelatorioCurvaSaidaProdutos},
  UtEstilo in 'Sobre\UtEstilo.pas' {FormStilo},
  UtCi in 'UtCi.pas' {FormCI},
  UtRelSocorro in 'UtRelSocorro.pas' {FormRelSocorro},
  UtRelOcoVeiculos in 'Relatorio\UtRelOcoVeiculos.pas' {FormRelOcorVeiculos},
  UtSubstituicaoVeiculos in 'Manutencao\UtSubstituicaoVeiculos.pas' {FormSubstituicaoVeiculos},
  UtRevisaoHistorico in 'UtRevisaoHistorico.pas' {FormRevisaoHistorico},
  UtNucleoRelatorio in 'Relatorio\UtNucleoRelatorio.pas' {FormNucleoRelatorios},
  UtVisaoOrcamento1 in 'Orcamento\UtVisaoOrcamento1.pas' {FormVisaoOrcamento1},
  UtOrcamentoContaDetalhada in 'Orcamento\UtOrcamentoContaDetalhada.pas' {FormOrcamentoContaDetalhada},
  UtAnaliseOrcamento1 in 'Orcamento\UtAnaliseOrcamento1.pas' {FormAnaliseOrcamento1},
  UtAtualizaBaseRevisaoComKm in 'UtAtualizaBaseRevisaoComKm.pas' {FormAtualizaBaseRevisaoComKm},
  UtGeraPlanilha in 'UtGeraPlanilha.pas' {FormGeraPlanilha},
  UtRequisitaProdutos in 'UtRequisitaProdutos.pas' {FormRequisitaProdutos},
  ClasseRequisicao in 'ClasseRequisicao.pas',
  UtrelDefRecleSoc in 'UtrelDefRecleSoc.pas' {FormRelDefeitosReclamadoseSocorro},
  UtRequisitaProdutosBusca in 'UtRequisitaProdutosBusca.pas' {FormRequisitaProdutosBusca},
  UtRequisicaoBaixa in 'Baixa\UtRequisicaoBaixa.pas' {FormRequisicaoBaixa},
  UtRequisicaoBalcao in 'Baixa\UtRequisicaoBalcao.pas' {FormRequisicaoBalcao},
  UtTotvsInventario in 'UtTotvsInventario.pas' {FormTotvsInventario},
  UtFrAvaria in 'Manutencao\UtFrAvaria.pas' {FrameAvaria: TFrame},
  UtListaImg in 'Manutencao\UtListaImg.pas' {ForMListaImg},
  UtAvariaMov in 'Manutencao\UtAvariaMov.pas' {FormAvariaMov},
  UtAvariaConclui in 'Manutencao\UtAvariaConclui.pas' {FormAvariaConclui},
  UtRelIndicadorRevisaoKm in 'UtRelIndicadorRevisaoKm.pas' {FormRelIndicadorRevisaoKm};
...
begin
  ...
  Application.Title := 'Center Bus - Revisão de Frotas';
